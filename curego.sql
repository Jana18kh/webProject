...
--
-- Host: localhost:8889
-- Generation Time: Apr 06, 2025 at 04:15 PM
...
CREATE TABLE `Appointment` (
  ...
  `status` enum('Pending','Confirmed','Done') COLLATE utf8mb4_general_ci DEFAULT 'Pending'
...
CREATE TABLE `Doctor` (
  ...
  `uniqueFileName` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `Medication` (
  `id` int NOT NULL,
  `MedicationName` varchar(100) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
