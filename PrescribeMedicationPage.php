...
$username = "if0_38793190";              // Username
$password = "VZrJdHAmkIV";               // Password
$dbname = "if0_38793190_curego";         // Database name
...
if (isset($_GET['id'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Update status to "Done" after prescribing
        $update_status_sql = "UPDATE Appointment SET status = 'Done' WHERE id = ?";
        ...
        // Redirect to a confirmation page or back to doctor homepage
