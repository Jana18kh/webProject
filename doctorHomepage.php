                ...
                <?php if ($appointments->num_rows > 0) {
                    while($row = $appointments->fetch_assoc()) { ?>
                        <tr>
                            ...
                            <td><?php echo $row['age']; ?></td>  <!-- Display age -->
                            <td><?php echo $row['gender']; ?></td>
                            <td><?php echo $row['reason']; ?></td>
                            <td><?php echo $row['status']; ?></td>
                            <td>
                                <?php if ($row['status'] == 'Pending') { ?>
                                    <a href="confirmappointment.php?id=<?php echo $row['id']; ?>">Confirm</a>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>Age</th>
                    <th>Gender</th>
                    <th>Medications</th>  <!-- Add column for medications -->
                </tr>
            </thead>
            <tbody>
                ...
                <?php while($patient = $patients->fetch_assoc()) { ?>
                    <tr>
                        ...
                        <td><?php echo $patient['age']; ?></td> <!-- Display age -->
                        <td><?php echo $patient['gender']; ?></td>
                        <td><?php echo $patient['medications']; ?></td>  <!-- Display medications -->
                    </tr>
                <?php } ?>
            </tbody>
        </table>
